...
public resetPassword(data): Observable<any> {
 ...
 public deleteUsers(userId):any{
  let data = {}
  let myResponse = this.http.post(`${this.baseUrl}/:userId/delete`, data);
 ...
 editUsers(id) {
  ...
  return this
          ...
          .get(`${this.baseUrl}userId/edit`);

  }



updateUsers(firstName,lastName,email) {
  ...
  this
    ...
    .post(`${this.baseUrl}/:userId/edit`, obj)
